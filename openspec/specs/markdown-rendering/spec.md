...
Defines the canonical, safe Markdown rendering contract for every TCRT browser surface: CommonMark 0.31.2 plus bounded GFM 0.29 extensions, self-hosted parser/sanitizer assets, deterministic Safe Display, source preservation, and verifiable readiness/fallback behavior.
