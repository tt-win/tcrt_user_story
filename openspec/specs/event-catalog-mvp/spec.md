# Event Catalog MVP Specification

## Purpose
Define the naming convention, event code registry, impact/outcome/level mappings, and Pydantic details schemas for TCRT's unified event catalog (audit and ops domains).
