# Audit Event Envelope Specification

## Purpose
Define the versioned envelope schema, event catalog authority, safe emit contract, legacy compatibility, and extended filtering/search for TCRT's audit system.
