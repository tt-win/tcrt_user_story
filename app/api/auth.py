    ...
    try:
        ...
        try:
            await audit_service.log_action(
                ...
                action_brief=f"User {user.username} logged in",
    ...
    try:
        ...
        try:
            ...
            await audit_service.log_action(
                ...
                action_brief=f"User {current_user.username} logged out",
                severity=AuditSeverity.INFO,
                ip_address=ip_address,
                user_agent=user_agent,
            )
...
async def first_login_setup(request: FirstLoginSetupRequest, http_request: Request):
    ...
    try:
        await audit_service.log_action(
            ...
            action_brief=f"User {user.username} completed first login setup",
            severity=AuditSeverity.INFO,
            ip_address=ip_address,
            user_agent=user_agent,
        )
