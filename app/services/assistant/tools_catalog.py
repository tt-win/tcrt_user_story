...
from app.services.assistant.tools_knowledge import TOOLS as _KNOWLEDGE_TOOLS
from app.services.assistant.tools_misc import LOCAL_TOOLS as _MISC_LOCAL_TOOLS
...
# misc local / skill / knowledge tools 是 local read；不進 batch_execute_actions 的 child enum。
ALL_TOOLS = [
    *_LOOPBACK_TOOLS,
    *_MISC_LOCAL_TOOLS,
    *_SKILL_TOOLS,
