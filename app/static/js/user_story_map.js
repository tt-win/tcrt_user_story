    ...
    const updateNodeProperties = (node) => {
        ...
        container.innerHTML = `
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control form-control-sm" id="propIWant" value="${escapeHtml(data.i_want || '')}" placeholder="I want to...">
            </div>
            <div class="mb-3">
                <label class="form-label small fw-bold">So that <small class="text-muted">(價值目的)</small></label>
                <input type="text" class="form-control form-control-sm" id="propSoThat" value="${escapeHtml(data.so_that || '')}" placeholder="So that...">
            </div>
            ` : ''}
