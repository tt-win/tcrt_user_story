...
Object.assign(window.i18n_dict['zh-TW'], {
  ...
  'setAsDefault': '設為預設',
  'setDefaultTitle': '設為預設 Test Case Set',
  'setDefaultConfirm': '確定要將「{name}」設為預設 Test Case Set 嗎？',
  'setDefaultHintTitle': '注意事項',
  'setDefaultHint': '既有 Test Case 不會被搬移，之後新建立的 ad-hoc run 與新 Test Case 會預設放入這個集合。',
  'setDefaultSuccess': '已更新預設 Test Case Set。',
  'switchSet': '切換集合',
  'currentSet': '當前集合',
  'manageSet': '管理集合',
  'testCaseCount': '個測試案例',
...
Object.assign(window.i18n_dict['zh-CN'], {
  ...
  'setAsDefault': '设为默认',
  'setDefaultTitle': '设为默认 Test Case Set',
  'setDefaultConfirm': '确定要将「{name}」设为默认 Test Case Set 吗？',
  'setDefaultHintTitle': '注意事项',
  'setDefaultHint': '既有 Test Case 不会被移动，之后新建的 ad-hoc run 与新 Test Case 会默认放入这个集合。',
  'setDefaultSuccess': '已更新默认 Test Case Set。',
  'switchSet': '切换集合',
  'currentSet': '当前集合',
  'manageSet': '管理集合',
  'testCaseCount': '个测试用例',
...
Object.assign(window.i18n_dict['en-US'], {
  ...
  'setDefaultTitle': 'Set as Default Test Case Set',
  'setDefaultConfirm': 'Are you sure you want to set "{name}" as the default Test Case Set?',
  'setDefaultHintTitle': 'What changes',
  'setDefaultHint': 'Existing test cases will not be moved. New ad-hoc runs and newly created test cases will go into this set by default.',
  'setDefaultSuccess': 'Default Test Case Set updated.',
