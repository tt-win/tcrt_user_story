/* commonmark 0.31.2 browser ESM wrapper; upstream BSD-2-Clause license. */
const commonmarkModule = {};
/* commonmark 0.31.2 https://github.com/commonmark/commonmark.js @license BSD3 */
(function (factory) {
    factory(commonmarkModule);
...
export default commonmarkModule;
export const {Parser, Renderer, HtmlRenderer, XmlRenderer, Node} = commonmarkModule;
